...
import { state, snapshot, isAnnotationHidden, labelById, labelDisplayName } from "../state.js?v=9";
...
import { setStatus, save, render, activateLabel, toggleAnnotationsHidden, unhideAllObjects, editBlockReason } from "../components/workspace.js?v=24";
