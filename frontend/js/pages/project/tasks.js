...
import { escapeHTML, formatTime, statusPillClass, TASK_STATUSES, LOCKED_TASK_STATUSES } from "../../utils.js?v=3";
...
// Both vocabularies now live in utils.js, shared with the workspace-wide task
// search on the projects page. Aliased so the rest of this module reads as before.
const STATUSES = TASK_STATUSES;
const LOCKED_STATUSES = LOCKED_TASK_STATUSES;
