"""Runs the data-table selection-retention spec under node, from pytest.
...
SPEC = Path(__file__).parent / "js" / "data_table_selection_spec.mjs"


@pytest.mark.skipif(shutil.which("node") is None, reason="node not installed")
def test_data_table_selection_spec():
