"""Runs the data-table Move Tasks column and nav-gate spec under node, from pytest.
...
SPEC = Path(__file__).parent / "js" / "move_columns_spec.mjs"


@pytest.mark.skipif(shutil.which("node") is None, reason="node not installed")
def test_move_columns_spec():
