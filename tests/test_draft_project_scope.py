"""Runs the data-table draft project-scope spec under node, from pytest.
...
SPEC = Path(__file__).parent / "js" / "draft_project_scope_spec.mjs"


@pytest.mark.skipif(shutil.which("node") is None, reason="node not installed")
def test_draft_project_scope_spec():
